...
class MShewchukPCGLinearSolver : public MBaseLinearSolver {
public:
    ...
    core::objectmodel::SingleLink<MShewchukPCGLinearSolver,BaseSystemMatrix,BaseLink::FLAG_STRONGLINK|BaseLink::FLAG_STOREPATH> l_matrix;
    core::objectmodel::SingleLink<MShewchukPCGLinearSolver,MBaseLinearSolver,BaseLink::FLAG_STRONGLINK|BaseLink::FLAG_STOREPATH> l_preconditioner;

    MShewchukPCGLinearSolver()
    ...
    virtual void buildSystemMatrix() override {
        ...
        if (l_preconditioner != NULL)
            l_preconditioner->setSystemMBKMatrix(this->getMParams());
    }
