...
MPCGLinearSolver<TMatrix,TVector>::MPCGLinearSolver()
...
template<class TMatrix, class TVector>
void MPCGLinearSolver<TMatrix,TVector>::init()
{
...
template<class TMatrix, class TVector>
void MPCGLinearSolver<TMatrix,TVector>::reinit()
{
    if(f_verbose.getValue())
    {
        this->f_printLog.setValue(true);
...
template<class TMatrix, class TVector>
void MPCGLinearSolver<TMatrix,TVector>::resetSystem()
{
...
template<class TMatrix, class TVector>
void MPCGLinearSolver<TMatrix,TVector>::setSystemMBKMatrix(const sofa::core::MechanicalParams* mparams)
{
...
/// Solve Mx=b
template<class TMatrix, class TVector>
void MPCGLinearSolver<TMatrix,TVector>::solve(Matrix& M, Vector& x, Vector& b)
{
...
template<class TMatrix, class TVector>
inline void MPCGLinearSolver<TMatrix,TVector>::cgstep_beta(const core::ExecParams* /*params*/, Vector& p, Vector& r, SReal beta)
{
    // p = p*beta + r
    p *= beta;
    p += r;
...
template<class TMatrix, class TVector>
inline void MPCGLinearSolver<TMatrix,TVector>::cgstep_alpha(const core::ExecParams* /*params*/, Vector& x, Vector& r, Vector& p, Vector& q, SReal alpha)
{
    // x = x + alpha p
    x.peq(p,alpha);
